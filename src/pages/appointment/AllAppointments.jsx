...
const AllAppointments = () => {
    ...
    useEffect(()=>{
        const fetchData=()=>{
            fetch('http://localhost:3010/appointment/allappointment')
    ...
    return (
        <>
            ...
            <Button className="link" startIcon={<AddIcon />} variant="outlined" component={Link} to="/addappointment" >Add New</Button>
            ...
            <AppointmentsList users={currentPosts} updateUsers={setUsers} />
